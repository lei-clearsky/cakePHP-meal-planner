...
<?php echo $this->Form->create('Shoppinglist'); ?>
	<fieldset>
		<legend><?php echo __('Edit Shoppinglist'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Shoppinglist.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Shoppinglist.id'))); ?></li>
